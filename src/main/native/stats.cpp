...
jobject Stats::create(JNIEnv* env, const uv_stat_t* ptr) {
  if (ptr) {
    ...
    return env->NewObject(
        ...
        blksize,
        blocks,
        ptr->st_atim.tv_nsec / 1000,     // Convert seconds to milliseconds //TODO
        ptr->st_mtim.tv_nsec / 1000,     // Convert seconds to milliseconds //TODO
        ptr->st_ctim.tv_nsec / 1000);    // Convert seconds to milliseconds // TODO
  }
  return NULL;
}
